...
// ”9Ý8 Vista completa si no es modal
include 'header.php';
?>
            ...
            ?>
                <tr>
                    ...
                    <td>
                        ...
                        <a href="eliminar_alojamiento.php?id=<?php echo $a['id']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('0†7Seguro que deseas eliminar este alojamiento?')">Eliminar</a>
                    </td>
                </tr>
            <?php endwhile; ?>
        </tbody>
