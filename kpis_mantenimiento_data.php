...
// KPIs operativos
$total        = obtener("SELECT COUNT(*) FROM ordenes_mantenimiento $where_total", $conn);
$pendientes   = obtener("SELECT COUNT(*) FROM ordenes_mantenimiento $where_reporte AND (estatus = 'Pendiente' OR estatus IS NULL OR TRIM(estatus) = '')", $conn);
$proceso      = obtener("SELECT COUNT(*) FROM ordenes_mantenimiento $where_reporte AND estatus = 'En proceso'", $conn);
$cancelados   = obtener("SELECT COUNT(*) FROM ordenes_mantenimiento $where_reporte AND estatus = 'Cancelado'", $conn);
$vencidos     = obtener("SELECT COUNT(*) FROM ordenes_mantenimiento $where_reporte AND estatus = 'Vencido'", $conn);
$terminados   = obtener("SELECT COUNT(*) FROM ordenes_mantenimiento $where_completado", $conn);
