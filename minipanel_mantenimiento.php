...
require_once 'app/providers/MantenimientoDataProvider.php';
...
$provider = new MantenimientoDataProvider($conn);
$options->setTotal($provider->getTotalCount());
$kpis  = $provider->getKpis();
$data  = $provider->getTableData($options);
$panel = new PanelResumen('Órdenes de Mantenimiento', $kpis, $data, $options);
?>
<!DOCTYPE html>
<html lang="es">
<head>
