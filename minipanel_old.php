...
<ul class="nav nav-tabs mb-4" id="tabsPanelCompras" role="tablist">
  <li class="nav-item" role="presentation">
    <button class="nav-link active" id="tab-ordenes-tab" data-bs-toggle="tab" data-bs-target="#tab-ordenes" type="button" role="tab">Órdenes de Compra</button>
  </li>
  <li class="nav-item" role="presentation">
...
<div class="tab-content" id="tabsPanelComprasContent">
  <!-- Pestaña 1: Órdenes de compra (ya existente) -->
