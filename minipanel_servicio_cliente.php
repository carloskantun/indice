...
require_once 'app/providers/ServicioClienteDataProvider.php';
...
$provider = new ServicioClienteDataProvider($conn);
$options->setTotal($provider->getTotalCount());
$kpis  = $provider->getKpis();
$data  = $provider->getTableData($options);
$panel = new PanelResumen('Órdenes de Servicio al Cliente', $kpis, $data, $options);
?>
<!DOCTYPE html>
<html lang="es">
<head>
