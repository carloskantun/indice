...
require_once 'app/providers/TransfersDataProvider.php';
...
$provider = new TransfersDataProvider($conn);
$options->setTotal($provider->getTotalCount());
$kpis  = $provider->getKpis();
$data  = $provider->getTableData($options);
$panel = new PanelResumen('Órdenes de Transfer', $kpis, $data, $options);
?>
<!DOCTYPE html>
<html lang="es">
<head>
